...
var RT = function () {
  function RT(username, password, host) {
    ...
    this.loggedIn = false;
    this.uribase = (0, _urlJoin2.default)(host, 'REST/1.0');
  }
  ...
  _createClass(RT, [{
    ...
    value: function search(query, callback) {
      var doQuery = function () {
        request({
          url: (0, _urlJoin2.default)(this.uribase, 'search/ticket'),
          qs: {
            query: query
          }
        }, function (error, response, body) {
    ...
    value: function ticketProperties(ticketId, callback) {
      var getTicketInfo = function () {
        request({
          url: (0, _urlJoin2.default)(this.uribase, 'ticket', ticketId, 'show')
        }, function (error, response, body) {
          var lines = body.split(/\r?\n/);
          var pattern = /^([^:]+): (.+)$/;
          var ticketInfo = {};
    ...
    value: function ticketHistory(ticketId, callback) {
      var getTicketHistory = function () {
        request({
          url: (0, _urlJoin2.default)(this.uribase, 'ticket', ticketId, 'history')
        }, function (error, response, body) {
          var lines = body.split(/\r?\n/);
          var pattern = /^(\d+): (.+)$/;
          var historyElements = {};
    ...
    value: function ticketHistoryEntry(ticketId, historyId, callback) {
      var getHistoryEntry = function () {
        request({
          url: (0, _urlJoin2.default)(this.uribase, 'ticket', ticketId, 'history/id', historyId)
        }, function (error, response, body) {
